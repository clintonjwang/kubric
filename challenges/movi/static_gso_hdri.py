...
parser.add_argument("--min_num_static_objects", type=int, default=3,
...
parser.add_argument("--camera", choices=["fixed_random", "spiral"],
                    default="spiral")
...
renderer = Blender(scene, scratch_dir, use_denoising=True, samples_per_pixel=64, motion_blur=0.0)
